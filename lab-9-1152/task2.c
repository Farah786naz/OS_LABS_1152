 ...
 // Threads are getting perfectly synchronized here and they are giving expected output.
 // the count increments in thread 1 function and immediately decrements in thread 2 function
 //the final counter should be zero and we got the same answer. 