...
// Critical section
 ...
 // if we comment the wait, the value never decrements and increase each time function is called.
// it will let any thread increment the counter, without locking critical section for 1 thread.
// No synchronization of threads here.